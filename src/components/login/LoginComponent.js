                    ...
                    <div className="header">
                      ...
                      <form className="form">
                        <div className="input-box">
                          <input type="text" id="name" aria-describedby placeholder="Phone number, username, or email" aria-required="true" maxLength={30} autoCapitalize="off" autoCorrect="off" name="username" required />
                        </div>
                        <div className="input-box">
