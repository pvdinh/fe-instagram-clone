...
function SignUpComponent(props) {
    ...
    useEffect(() => {
        checkSignup()
    }, [username, password, phone,email, fullname,props.checkPhone,props.checkEmail,props.checkUsername,checkLogin,verifyPassword])
    ...
    const onChangeVerifyPassword = (e) => {
        ...
        checkVerifyPassword(e.target.value)
    }
                                            ...
                                            <div className="input-box" >
                                                <Form.Item hasFeedback validateStatus={validateVerifyPassword}>
                                                    <input type="password" name="verifyPassword" value={verifyPassword} id="verifyPassword"
                                                           ...
                                                           onBlur={()=>{checkVerifyPasswordBlur()}}
                                                           placeholder="Verify Password" aria-describedby maxLength={30}
                                                           aria-required="true" autoCapitalize="off" autoCorrect="off"
                                                           required/>
                                                </Form.Item>
