                    ...
                    <section className="side-menu">
                        ...
                        <div className="side-menu__suggestions-section" style={{
                            ...
                            <div className="side-menu__suggestions-content">
                                ...
                                <div>
                                    <div className="privacy-group-detail"><AiOutlineHistory />
                        ...
                        {/*</div>*/}
                        <ModalFeedback visible={isModalFeedbackVisible} setVisible={() => {
            ...
            <nav className="navbar">
                ...
                <button className="navbar__button profile-button">
                    ...
                    <div className="profile-button__picture">
                        <img
                            src="https://res.cloudinary.com/dinhpv/image/upload/v1639995035/instargram-clone/u0bzzpthtzw9lik72gy6.jpg"
                            alt="User Picture"/>
                    </div>
                </button>
            </nav>
