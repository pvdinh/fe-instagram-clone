               ...
               <main>
                   <section className="bio">
                       <div className="bio__img-block">
                           <a href><img className="bio__img" src="https://res.cloudinary.com/dinhpv/image/upload/v1626605290/instargram-clone/fnvb273cxogfhsuz0dcq.jpg" alt="profile picture" /></a>
                       </div>
