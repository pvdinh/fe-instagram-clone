                    ...
                    <article className="post">
                        ...
                        <div className="post__footer">
                            <div className="post__buttons">
                                ...
                                <button className="post__button__other" onClick={()=>{setIsVisiblePostDetail(true)}}>
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                         xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                listComment.slice(listComment.length - 2, listComment.length).map((item, index) => (
                                                    <div className="comment">
                                                            <a href={`/${item.userAccountSetting.username}`}
                                                                style={{fontWeight: "600",color:"var(--text-dark)",overflowWrap: "break-word"}}>{item.userAccountSetting.username}</a>
                                                        <span> {item.comment.content}</span>
                                                        <div style={{display:"flex", alignItems: "center"}}>
                                                            <p className="text-number-like">{fShortenNumber(1000)}</p>
                                                            <div className="wrap-like">
                                                                <svg className="_8-yf5 " height="13" fill="var(--like)"
                                                                     viewBox="0 0 48 48" width="13">
                                                                    <path
                                                                        d="M34.6 3.1c-4.5 0-7.9 1.8-10.6 5.6-2.7-3.7-6.1-5.5-10.6-5.5C6 3.1 0 9.6 0 17.6c0 7.3 5.4 12 10.6 16.5.6.5 1.3 1.1 1.9 1.7l2.3 2c4.4 3.9 6.6 5.9 7.6 6.5.5.3 1.1.5 1.6.5s1.1-.2 1.6-.5c1-.6 2.8-2.2 7.8-6.8l2-1.8c.7-.6 1.3-1.2 2-1.7C42.7 29.6 48 25 48 17.6c0-8-6-14.5-13.4-14.5z"></path>
                                                                </svg>
                                                            </div>
