    ...
    return(
        <>
                ...
                <div className="post-bottom">
                    <div className="buttons">
                        <div>
                            {
                                like ?
                                    <button className='home-heart red' onClick={()=>{onClickLike()}}>
                                    ...
                                    :
                                    <button className='home-heart black' onClick={()=>{onClickLike()}}>
                                        <svg
                                            className="_8-yf5 "
                                            height={24}
                                            viewBox="0 0 48 48"
            ...
            <div className="post">
                ...
                <div className="post-media">
                    <img
                        src="https://res.cloudinary.com/dinhpv/image/upload/v1624981801/instagram-clone/211063261717326967064831556274527304136988n-1523674805536851614581_alba5m.jpg"
                        alt="Post"
                    />
                </div>
                <div className="post-bottom">
                    ...
                    <span className="likes">
              Liked by <a href="#">another-user</a> and{" "}
                        <strong>112.534 other</strong>
            </span>
                    <p className="desc">
                        <a href="#">user-nickname</a> Post example.
                    </p>
